...
("⭐ Plaza de España",37.376903,-5.98565,9,"attraction","Seville",
 "⭐ 8:30 PM in golden light (free), your closest big sight. Pack tonight: the Granada train leaves 09:55 tomorrow.",
 None,20,60,False),
("Triana + Calle Betis 🌆",37.383296,-5.999693,9,"food","Seville",
 "🌆 Across the Isabel II bridge — the old ceramics and flamenco quarter, and the answer to 'where's dinner on Day 9', which was previously blank. Calle Betis runs right along the water with the Torre del Oro and the cathedral lit up on the far bank; the bars behind it (Calle San Jacinto, Mercado de Triana) are cheaper and far less touristed than Santa Cruz. Flamenco if you want it: Teatro Flamenco Triana or Casa de la Guitarra, €20–30. 25 min on foot from Plaza de España or a ~€7 taxi. ⚠️ Pick this OR El Rinconcillo — they're opposite ends of the city and each is a whole evening.",
 None,21,90,False),
