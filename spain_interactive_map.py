...
("CDG — Paris layover ✈️",49.0097,2.5479,2,"flight","Transit",
 ...
 None,11,165,True),
("OPO Airport — Arrive Porto",41.248962,-8.68028,2,"flight","Porto",
 ...
 None,15,30,True),
("Sheraton Porto Hotel & Spa 🏨",41.16112,-8.639831,2,"hotel","Porto",
...
("🌄 Pedra dos Gatinhos",41.1381,-8.6071,2,"viewpoint","Porto",
 ...
 None,19,15,False),
("🚡 Teleférico de Gaia (cable car)",41.137617,-8.612911,2,"attraction","Porto",
...
("Jardim do Morro 🌄",41.13762,-8.608689,2,"viewpoint","Porto",
...
("Dom Luís I Bridge 🌄",41.1399,-8.6094,2,"viewpoint","Porto",
 ...
 None,21,20,False),
("Café Santiago (dinner)",41.146431,-8.604772,2,"food","Porto",
...
("✊ UNICEPE bookshop",41.1478,-8.6155,3,"history","Porto",
 "✊📚 Porto's student book cooperative, a left-wing institution since 1964, on Praça de Carlos Alberto — 270 m from Clérigos and barely 100 m from Lello, so it costs you a 3-minute walk. 15-min browse; if shut, Livraria Latina fills in.",
 None,9,15,False),
("São Bento azulejo hall",41.144688,-8.610785,3,"moorish","Porto",
...
("Mercado do Bolhão (lunch)",41.1497,-8.6062,3,"food","Porto",
 ...
 None,12,40,False),
("Casa Guedes 🥪",41.145997,-8.604046,3,"food","Porto",
...
("Sé do Porto (Cathedral)",41.1426,-8.6115,3,"attraction","Porto",
 ...
 None,14,25,False),
("Rua das Flores 🛍",41.144455,-8.612639,3,"shop","Porto",
...
("🍷 Taylor's Port Cellars",41.13434,-8.614403,3,"food","Porto",
...
("O Valentim (dinner, Matosinhos)",41.179083,-8.691111,3,"food","Porto",
...
("Corinthia Lisbon 🏨",38.738765,-9.16649,4,"hotel","Lisbon",
...
("🕌 Alfama + Miradouro de Santa Luzia",38.7118,-9.1300,4,"moorish","Lisbon",
 "🕌 2:00 PM the old Moorish quarter (from Arabic al-hamma) — wander the lanes up to the tiled Santa Luzia terrace. 🌄 Both viewpoints on your list are here and 80 m apart: Santa Luzia is the tiled pergola with the bougainvillea, and Portas do Sol is the wide café terrace immediately above it looking down over the Alfama rooftops to the river. Do them as one stop — walk out of Santa Luzia, up the steps, and you're at Portas do Sol.",
 None,14,90,False),
...
("🌄 Miradouro da Senhora do Monte",38.7186,-9.1337,4,"viewpoint","Lisbon",
 "🌄 The highest terrace in Lisbon — castle, Baixa, the river and the 25 de Abril bridge in one frame, with a pine-shaded wall to sit on and none of the Santa Luzia crowd. Free, never gated, ~20 min walk north through Graça from the castle. ⚠️ Honest note on the 'sunset' plan: on Aug 9 the sun doesn't drop until ~8:35 PM and you're booked into Tasca do Chico at 8:30. At 7 PM you get low golden light but not the sunset itself. If you want the real thing, push fado to 9 PM — Tasca do Chico runs late and the second set is the better one anyway.",
 None,19,30,False),
...
("Sete Rios → Sintra train 🚆",38.740241,-9.167203,5,"train","Sintra",
...
("Tascantiga — Sintra lunch 🍽",38.795715,-9.391032,5,"food","Sintra",
 ...
 None,14,60,False),
("⭐ Quinta da Regaleira (optional)",38.795112,-9.396203,5,"attraction","Sintra",
...
("🌘 Solar eclipse — SVQ arrival",37.417703,-5.894929,7,"eclipse","Seville",
...
("Hotel Giralda Center 🏨",37.381102,-5.982991,7,"hotel","Seville",
...
("La Terraza de EME 🍸🌄",37.3860,-5.9928,7,"food","Seville",
 "🍸🌄 Rooftop bar on the EME Catedral hotel, close enough to the Giralda that the tower fills the frame — floodlit once it's dark, which on your first night lands perfectly. It is a 12-min walk in from the hotel — the Giralda Center sits out in San Bernardo, about 1 km east of the old town, not in Santa Cruz — so do this and the tapas below as one trip rather than two. Drinks ~€12–16; no booking needed for the bar, but head up before ~11 PM on an August night or you'll queue. Smart-casual — no beachwear or flip-flops.",
 None,21,45,False),
("Barrio Santa Cruz — late tapas",37.38623,-5.99163,7,"food","Seville",
...
("Lunch in Córdoba (free time)",37.879757,-4.780035,8,"food","Cordoba",
 "🍽 12:15–13:30 free time for lunch. Salmorejo + flamenquín: Taberna Salinas (patio taberna since 1879), or Bar Santos' famous giant tortilla slice right by the Mezquita. 🥙 Your Damasco pick works too — the Syrian place in the Judería, a genuinely good change of gear from three days of fried Andalusian food, and quick enough for the window. ⚠️ Back at the coach by 13:30 — it leaves for Setenil without you.",
 None,12,75,False),
("Setenil de las Bodegas 🌄",36.861865,-5.177919,8,"attraction","Setenil",
...
("⭐ Ronda — Puente Nuevo 🌄",36.740715,-5.165877,8,"viewpoint","Ronda",
...
("🕌 Cathedral + Giralda",37.3859,-5.9932,9,"moorish","Seville",
 "🕌 3:00 PM (~€13 timed) — climb the 12th-c. Almohad minaret; ramps, not stairs, built for a horse. Moved to the afternoon because the 11:30 Alcázar took the morning and the cathedral does not open until 11:00 anyway, so it could not have gone first. ⚠️ Check the last admission when you book — it is around 4 PM in August, so 3:00 is the safe arrival. 🌡 This is also the sensible way to spend peak heat: it is the coolest interior in Seville, all stone and shade.",
 "https://www.catedraldesevilla.es",15,90,False),
("Siesta / pool 🏊",37.381102,-5.982991,9,"hotel","Seville",
 "☀️ 5:00–6:00 PM — shorter than planned, because the 11:30 Alcázar pushed the cathedral into the afternoon. You are not losing the rest so much as taking it inside the cathedral instead: the heat protocol wants you out of the sun 14:00–18:00, and between the Alcázar gardens, lunch and the cathedral nave you are shaded through all of it. An hour by the pool before the evening still does the job.",
 None,17,0,True),
("🛍 Calle Sierpes & Calle Tetuán",37.391095,-5.994567,9,"shop","Seville",
 "🛍 Seville's two pedestrian shopping streets, running parallel from Plaza Nueva up to La Campana. Everything on your list is on or just off them — Zara, Pull&Bear, Bershka, Stradivarius on Tetuán, and the century-old fan, hat and abanico shops on Sierpes. Awnings strung overhead the whole way. ⏰ 6:00 PM works well: Spanish shops reopen from siesta around 5 and run to 21:00, so you get the cooler end of the afternoon with everything open.",
 None,18,60,False),
("⭐ Plaza de España",37.376903,-5.98565,9,"attraction","Seville",
 "⭐ 8:00 PM in golden light (free) — sunset is about 21:30 in mid-August, so this is the hour it looks best. Pack tonight: the Granada train leaves 09:55 tomorrow.",
 None,20,60,False),
("Triana + Calle Betis 🌆",37.383296,-5.999693,9,"food","Seville",
 "🌆 Across the Isabel II bridge — the old ceramics and flamenco quarter, and dinner. Calle Betis runs right along the water with the Torre del Oro and the cathedral lit up on the far bank; the bars behind it (Calle San Jacinto, Mercado de Triana) are cheaper and far less touristed than Santa Cruz. Flamenco if you want it: Teatro Flamenco Triana or Casa de la Guitarra, €20–30. 25 min on foot from Plaza de España or a ~€7 taxi. ⚠️ Pick this OR El Rinconcillo — they're opposite ends of the city and each is a whole evening.",
 None,21,90,False),
("El Rinconcillo 🍷",37.393341,-5.988294,9,"food","Seville",
 "🍷 Seville's oldest tapas bar, pouring since 1670 — tiled walls, hams hanging over the counter, and the barman still chalks your tab straight onto the wood. Order the espinacas con garbanzos and the bacalao; both are the house benchmark. No reservations, standing at the bar is the point, ~€3–4 a tapa. 20 min walk north from Plaza de España. ⚠️ Alternative to Triana above, not as well as it — pick one and commit.",
 None,21,60,False),
...
("Calle Navas — free-tapas crawl",37.1740,-3.5975,10,"food","Granada",
 ...
 None,21,90,False),
("Taberna La Tana 🍷",37.172748,-3.596091,10,"food","Granada",
...
("✊ Centro Federico García Lorca",37.176632,-3.600897,11,"history","Granada",
...
("Airbnb — Plaza Mayor 🏨",40.4155,-3.7075,12,"hotel","Madrid",
 ...
 None,19,0,True),
("✊ Reina Sofía (Guernica)",40.4079,-3.6947,12,"history","Madrid",
 "✊ Rescued from Tuesday — the Reina Sofía is CLOSED Tuesdays, which is when Day 13 falls, but it is open Mondays until 21:00 and entry is FREE from 19:00. Your train lands at Atocha at 18:40 and the museum is 300 m from the platform. 🧳 Drop the bags at the flat first (10-min taxi), then come back — 8 minutes, and you are inside by 19:15 with 90 minutes for Guernica. Picasso painted it for the 1937 Paris Expo as a scream about the bombing of Gernika; it hung in New York until Franco was dead and Spain was a democracy. Room 206. Dalí and Miró on the same floor if there is time.",
 "https://www.museoreinasofia.es/en",19,90,False),
("La Casa del Abuelo 🦐",40.4165,-3.7018,12,"food","Madrid",
 "🦐 Gambas al ajillo since 1906 — the sizzling garlic-shrimp tapa Anthony Bourdain came for, at the standing-room original off Puerta del Sol. Pair it with a chato of sweet 'vino del abuelo,' ~€12–15. Your first-night Madrid tapa, a few steps off Sol on the way to dinner. ⏰ 9 PM now — the free Reina Sofía window runs to 21:00 and this is 1.4 km from its door.",
 None,21,20,False),
("La Latina → Mercado de San Miguel",40.4154,-3.7090,12,"food","Madrid",
 "🍽 9:30 PM La Latina tapas crawl → Plaza Mayor → Mercado de San Miguel (2 min from your door). Late, but this is Madrid on a Monday and the kitchens do not care. 🇪🇸 Friend alt in Lavapiés: Taberna El Sur, near ✊ Traficantes de Sueños left bookshop.",
 None,21,120,False),

# ---- Day 13: Madrid full day ----
("⭐ Museo Thyssen-Bornemisza",40.4160,-3.6946,13,"museum","Madrid",
 "⭐ 10:00 AM (~€14) — takes the Reina Sofía's slot because that one shuts on Tuesdays. No consolation prize: the Thyssen is the third corner of the Golden Triangle and the only one of the three that runs straight through Western art from the 13th century to Pop, so it slots either side of tonight's Prado rather than repeating it. Holbein, Caravaggio, Van Gogh, Hopper's Hotel Room. Open Tue–Sun 10:00–19:00, air-conditioned, and rarely queued at opening. 400 m from Cuesta de Moyano, your next stop, and 300 m from the Prado door for later.",
 "https://www.museothyssen.org/en",10,105,False),
("📚 Cuesta de Moyano book stalls",40.409608,-3.690476,13,"history","Madrid",
...
("⭐🛍 Casa Hernanz → Gran Vía shops",40.414215,-3.707674,13,"shop","Madrid",
 ...
 None,16,45,False),
("🛍 Antigua Casa Crespo (espadrilles)",40.427694,-3.704592,13,"shop","Madrid",
...
("⭐ Templo de Debod (sunset) 🌄",40.4240,-3.7176,13,"attraction","Madrid",
 ...
 None,20,75,False),
("Casa Revuelta — late bacalao 🍺",40.413922,-3.707839,13,"food","Madrid",
...
("🚌 Tour meet-up — Ventas / Calle Julio Camba",40.432031,-3.664781,14,"bus","Madrid",
...
("🌄 Toledo panoramic tour (from the coach)",39.8500,-4.0230,14,"viewpoint","Toledo",
 ...
 None,9,60,False),
("⭐ Toledo walking tour + Cathedral",39.856625,-4.024007,14,"attraction","Toledo",
...
("🕌 Cristo de la Luz / Santa María la Blanca (free time)",39.860595,-4.024176,14,"moorish","Toledo",
...
("Lunch in Segovia",40.950329,-4.123986,14,"food","Segovia",
...
("🌄 Mirador de la Pradera de San Marcos (optional)",40.954385,-4.134089,14,"viewpoint","Segovia",
...
("Free Madrid morning",40.4155,-3.7075,15,"attraction","Madrid",
 ...
 None,9,60,True),
("Royal Palace (from below) + Campo del Moro",40.418076,-3.717771,15,"attraction","Madrid",
...
MODE_TO = {
 ...
 "🕌 Muralla Árabe":"taxi",
 "⭐ Museo Thyssen-Bornemisza":"taxi",   # 1.4 km from the Plaza Mayor flat
...
_C = {
 "OPO":(41.248962,-8.68028),"Sheraton":(41.16112,-8.639831),"Campanha":(41.1490,-8.5850),"Lello":(41.1470,-8.6146),
 "Corinthia":(38.738765,-9.16649),"SeteRios":(38.740241,-9.167203),"SantaApolonia":(38.7139,-9.1224),"Rossio":(38.7143,-9.1400),
 "SintraSt":(38.7986,-9.3866),"Castelo":(38.7925,-9.3888),"Regaleira":(38.795112,-9.396203),
 "BairroAlto":(38.7118,-9.1447),"Jeronimos":(38.6979,-9.2065),"Gulbenkian":(38.7376,-9.1537),"LIS":(38.7742,-9.1342),
 "Giralda":(37.381102,-5.982991),"Alcazar":(37.3830,-5.9906),"SantaJusta":(37.3919,-5.9757),
...
GUIDE = {
 ...
 "🛍 Feira da Ladra flea market":"https://en.wikipedia.org/wiki/Feira_da_Ladra",
 "🛍 Calle Sierpes & Calle Tetuán":"https://en.wikipedia.org/wiki/Calle_Sierpes",
 "Triana + Calle Betis 🌆":"https://en.wikipedia.org/wiki/Triana,_Seville",
...
MAP_PLACE = {
 ...
 "⭐ Museo Thyssen-Bornemisza":"Museo Nacional Thyssen-Bornemisza, Madrid",
